    ...
    return (
        <div>
            <div className="forecast-header">
              <label className="title">Five days Forecast</label>
              <button onClick={() => {setMultiSelect(!multiSelect); changeButtonDta() } } className="multi-select-button" style={{ backgroundColor: buttonColor }}>{buttonData}</button>
            </div>
